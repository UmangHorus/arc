...
export default function RecentInvoices() {
  ...
  const dummyData = useMemo(() => [
    { id: "INV001", fullorder_no: "INV-2025-001", customername: "Global Traders", createdate: "2025-11-12", status_flg: "A", location: "Bangalore", gmapAddress: "Koramangala, Bangalore" },
    { id: "INV002", fullorder_no: "INV-2025-002", customername: "TechMart", createdate: "2025-11-09", status_flg: "P", location: "Hyderabad", gmapAddress: "Hi-Tech City, Hyderabad" },
    { id: "INV003", fullorder_no: "INV-2025-003", customername: "Alpha Corp", createdate: "2025-11-06", status_flg: "C", location: "Chennai", gmapAddress: "T Nagar, Chennai" },
  ], []);
  ...
  const columns = useMemo(() => [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        const display = status === "A" ? "Paid" : status === "C" ? "Completed" : status === "P" ? "Pending" : "N/A";
        const badge = { Paid: "bg-[#287F71]", Completed: "bg-green-600", Pending: "bg-orange-500", "N/A": "bg-gray-500" };
  ...
  return (
    <div className="bg-white p-4 rounded-lg shadow">
      <TableComponent table={table} title={`Recent 10 ${pluralize(invoiceLabel)}`} />
    </div>
  );
}