...
import QuotationDetailsDialog from "@/components/shared/QuotationDetailsDialog";
import { useRouter } from "next/navigation";

const ContactQuotation = ({ quotationData, contact }) => {
  ...
  // Process quotationData
  useEffect(() => {
    if (quotationData && Array.isArray(quotationData)) {
      const quotationList = quotationData
      ...
      console.error("Invalid or missing quotation data");
    }
  ...
  const table = useReactTable({
    ...
    globalFilterFn: (row, columnId, filterValue) => {
      ...
      return ["fullquotationno", "createdate", "customername", "status_flg", "created_by", "create_from"].some((key) =>
